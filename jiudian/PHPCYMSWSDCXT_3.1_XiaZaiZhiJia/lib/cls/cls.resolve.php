...
class cls_resolve {
	...
	//重刷新模板
	function on_refresh($msghtml,$msghtml2="")
	{
		$html_path=$msghtml;
		if(!file_exists($html_path)) return "";
	...
	function temp_replace_if($str_source)
	{
	...
	function temp_replace_foreach($msgstr)
	{
		$str_source=$msgstr;
