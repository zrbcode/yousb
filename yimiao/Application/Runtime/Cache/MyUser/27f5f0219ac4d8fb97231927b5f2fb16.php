...
<link rel="stylesheet" type="text/css" href="/yimiao/Application/MyUser/View/Public/Login/css/bootstrap.min.css" />
<link rel="stylesheet" type="text/css" href="/yimiao/Application/MyUser/View/Public/Login/css/style.css" />

<script src="/yimiao/Application/MyUser/View/Public/Login/js/jquery-1.7.2.min.js" type="text/javascript"></script>
...
<div class="login_div">
	<div class="col-xs-12 login_title">后台用户管理登录</div>
	<form action="<?php echo U('DoLogin');?>" class="login" method="post">
		<div class="nav">
			<div class="nav login_nav">
				...
				<div class="col-xs-6 login_usernameInput">
					<input type="text" name="name" id="name" value="" placeholder="&nbsp;&nbsp;用户名"  onblur="javascript:ok_or_errorBylogin(this)" />
				</div>
